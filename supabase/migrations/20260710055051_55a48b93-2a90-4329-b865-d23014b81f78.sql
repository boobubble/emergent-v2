-- Fix admin_export_schema_sql: line 89 used a non-E string with '\n' which
-- Postgres emits as the literal two chars backslash+n, producing invalid
-- SQL like "... NOT NULL DEFAULT now()\n);". Replace with E-string.
