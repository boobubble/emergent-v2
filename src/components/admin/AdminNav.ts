...
export const ADMIN_NAV: AdminGroup[] = [
...

  {
    label: "Settings", icon: Settings, children: [
      ...
      { to: "/admin/discovery-localization", label: "Discovery & Localization", icon: Compass, keywords: ["discovery", "country", "language", "interests", "onboarding", "localization", "hybrid", "isolation", "yaarzo"] },
    ],
  },

  {
    label: "Manage Features", icon: Puzzle, children: [
      ...
      { to: "/admin/social-automation", label: "Social Automation", icon: Share2, keywords: ["buffer", "facebook", "twitter", "x", "tiktok", "instagram", "pinterest", "bluesky", "youtube", "social", "auto post", "signup", "manual posts"] },
...

  {
    label: "Community", icon: MessageSquare, children: [
      ...
      { to: "/admin/content-automation", label: "Content Automation", icon: Zap, keywords: ["blog", "pages", "publish", "cron", "topics", "ideas", "auto publish"] },
...

  {
    label: "Moderation", icon: Gavel, children: [
      ...
      { to: "/admin/avatar-safety",      label: "Avatar Safety",     icon: ShieldAlert, keywords: ["avatar", "profile picture", "image", "moderation", "nudity", "nsfw", "remove", "review"] },
