import { Bug, Lightbulb, Palette, Zap, Shield, HelpCircle, type LucideIcon } from "lucide-react";

export type FeedbackCategory = "bug" | "feature" | "ui" | "performance" | "security" | "other";
...
export const STATUS_META: Record<FeedbackStatus, { label: string; tone: string }> = {
  ...
  investigating: { label: "Investigating", tone: "bg-amber-500/15 text-amber-600 dark:text-amber-300" },
  ...
  fixed:         { label: "Fixed",         tone: "bg-emerald-500/15 text-emerald-600 dark:text-emerald-300" },
...
export const FEEDBACK_CATEGORIES: FeedbackCategory[] =
  ["bug", "feature", "ui", "performance", "security", "other"];
