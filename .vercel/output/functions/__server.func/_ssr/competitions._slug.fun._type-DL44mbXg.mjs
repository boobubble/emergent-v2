...
import { dA as Route$2, a as useAuth, cO as listCompetitionNominees, ct as FUN_META, cr as listCompetitionMemes } from "./router-CYWPFaDK.mjs";
...
function FunTypePage() {
  ...
  reactExports.useEffect(() => {
    ...
    load();
    const ch = supabase.channel(`comp-fun-${competition.id}-${category}`).on("postgres_changes", {
      event: "*",
      schema: "public",
      table: "posts",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-2xl space-y-4 p-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: `rounded-2xl border bg-gradient-to-br ${meta.accent} p-4`, children: [
      ...
      nominees.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 flex flex-wrap gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/competitions/$slug/fun/$type", params: {
          slug: competition.slug,
          type: meta.slug
        }, search: {
          nominee: ""
        }, className: `rounded-full border px-2.5 py-1 text-[11px] font-semibold ${!nominee ? "border-primary bg-primary/10 text-primary" : "border-border text-muted-foreground hover:text-foreground"}`, children: "All" }),
        nominees.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/competitions/$slug/fun/$type", params: {
          slug: competition.slug,
          type: meta.slug
        }, search: {
          nominee: n.id
    ...
    posts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border bg-card p-10 text-center text-sm text-muted-foreground", children: [
      "No ",
      meta.plural.toLowerCase(),
      " yet. Head to the Feed composer, pick ",
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold", children: [
        "🎉 Fun → ",
        meta.label
      ] }),
      ", and tag this competition."
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: posts.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(PostCard, { post: p, profiles, meId }, p.id)) })
  ] });
}
export {
  FunTypePage as component
};
