...
import { u as useAppSettings, R as RouteErrorBoundary } from "./router-CYWPFaDK.mjs";
...
function HomeRouter() {
  ...
  if (layoutPriority === "feed_first") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Navigate, { to: "/feed", replace: true });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(RouteErrorBoundary, { section: "Chatrooms", featureStore: "chat", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChatApp, {}) });
}
export {
  HomeRouter as component
};
