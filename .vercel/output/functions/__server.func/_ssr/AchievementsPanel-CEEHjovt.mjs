...
import { g as useChat, Q as BADGES, S as TIER_COLOR } from "./router-CYWPFaDK.mjs";
...
import { m as Award, W as Lock } from "../_libs/lucide-react.mjs";
...
function AchievementsPanel() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 rounded-2xl border border-border bg-background/50 p-4", children: [
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: has ? b.emoji : /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { className: "h-4 w-4" })
              }
            ),
