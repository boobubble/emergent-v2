import { r as resolvePageSeo } from "./sitemap-Dl8Aqg_O.mjs";
function effectiveTitle(page, global) {
  return resolvePageSeo(page, global, { routePath: page.route_path ?? "/" }).title;
}
function effectiveDescription(page, global) {
  return resolvePageSeo(page, global, { routePath: page.route_path ?? "/" }).description;
}
function auditSeoHealth(pages, global) {
