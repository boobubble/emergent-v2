...
import { d5 as Route$F, a as useAuth } from "./router-CYWPFaDK.mjs";
...
function UserProfileRedirect() {
  ...
  if (isSelf) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Navigate, { to: "/feed", search: {
      tab: "account"
    }, replace: true });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Navigate, { to: "/feed", search: {
...
export {
  UserProfileRedirect as component
};
