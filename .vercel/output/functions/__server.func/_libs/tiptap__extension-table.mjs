import { N as Node3, m as mergeAttributes, x as callOrReturn, y as getExtensionField, A as findParentNodeClosestToPos, l as Extension } from "./tiptap__core.mjs";
import { T as TextSelection } from "./prosemirror-state.mjs";
import { c as columnResizing, t as tableEditing, C as CellSelection, f as fixTables, g as goToNextCell, s as setCellAttr, m as mergeCells, a as splitCell, b as toggleHeaderCell, d as toggleHeader, e as deleteTable, h as deleteRow, i as addRowAfter, j as addRowBefore, k as deleteColumn, l as addColumnAfter, n as addColumnBefore } from "./prosemirror-tables.mjs";
  ...
  while (i < line.length) {
    ...
    while (j < line.length) {
      ...
      if (closeLen === runLen) {
        ...
        result += line.slice(i, i + runLen) + spanContent.replace(new RegExp("(?<!\\\\)\\|", "g"), "\\|") + line.slice(j, j + runLen);
        i = j + runLen;
        found = true;
        break;
      }
