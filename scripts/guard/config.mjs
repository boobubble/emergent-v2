...
export const MODULES = {
  homepage: {
    ...
    paths: [
      ...
      "src/routes/heropage.tsx",
      "src/components/landing/",
      "src/__tests__/homepage-auth-cta.test.ts",
  ...
  chatroom: {
    ...
    paths: [
      ...
      "src/lib/chat-image-retention.ts",
      "src/lib/chat-image-retention.test.ts",
      "src/lib/chat-image-security.test.ts",
      "src/lib/chat-image-access.ts",
      "src/lib/chat-image.functions.ts",
      "src/routes/api/run-chat-image-cleanup.ts",
      "supabase/migrations/20260910120000_chat_ephemeral_images.sql",
      "supabase/migrations/20260910130000_chat_image_assets_registry.sql",
      "src/lib/global-unread.ts",
      "src/lib/global-unread.test.ts",
      "src/lib/use-channel-moderation.ts",
      "src/lib/moderation-chat.test.ts",
      "src/lib/sound-prefs.test.ts",
      "src/lib/chat-settings-drawer.test.ts",
      "src/lib/irc-rooms.ts",
      "src/lib/irc-rooms.test.ts",
      "src/lib/chat-dm-stability.test.ts",
      "src/lib/irc-moderation-client.ts",
      "src/lib/moderation.functions.ts",
      "src/lib/use-notifications.tsx",
      "src/lib/sound-prefs.ts",
      "src/lib/sounds.ts",
      "src/lib/dm-url-mask.tsx",
      "src/lib/dm-utils.ts",
      "src/lib/rate-limit-config.ts",
      "src/lib/guest-dm-config.ts",
      "src/lib/guest-dm-utils.ts",
      "src/lib/guest-dm-unread.ts",
      "src/lib/guest-dm-feed.ts",
      "src/lib/guest-dm-store.ts",
      "src/lib/guest-dm.functions.ts",
      "src/lib/use-guest-dm-feed.ts",
    ...
    tests: [
      ...
      "src/lib/irc-rooms.test.ts",
      "src/lib/chat-dm-stability.test.ts",
      "src/lib/irc-moderation-client.test.ts",
      "src/lib/global-unread.test.ts",
      "src/lib/guest-dm.test.ts",
      "src/lib/media-embed.test.ts",
      "src/components/chat/youtube-player.test.ts",
      "src/lib/watch-together-sync.test.ts",
      "src/lib/watch-together-actions.test.ts",
      "src/lib/chat-image-retention.test.ts",
      "src/lib/chat-image-security.test.ts",
    ],
  },
  ...
  auth: {
    ...
    paths: [
      ...
      "src/components/auth/AuthDialogs.tsx",
      "src/components/auth/AuthScreen.tsx",
      "src/components/auth/ContinueAsGuestButton.tsx",
      "src/lib/auth-entry.ts",
